        ...
        <form  method="POST" id="formRecherche" action="">
          ...
          <div id="divFiltre" style="display:none">
            ...
            <div id="divFiltreGrotte" style="display:none">
              ...
              <select data-placeholder='Choisissez une grotte...' class='chosen-select-width' name="filtreGrotte" id="filtreGrotte" onchange="majListes('grotte');">
            ...
            <div id="divFiltreSite" style="display:none">
              ...
              <select data-placeholder='Choisissez un filtre...' class='chosen-select-width' name="filtreSite" id="filtreSite" onchange="majListes('site');">
            ...
            <div id="divFiltrePiege" style="display:none">
              ...
              <select data-placeholder='Choisissez un piège...' class='chosen-select-width' name="filtrePiege" id="filtrePiege" onchange="majListes('piege');">
                <option value="tous" selected>Tous</option>
                <?php
